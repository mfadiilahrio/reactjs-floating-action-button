...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <p>Hello :)</p>
        <p>This is React Web App sample for Floating Action Button With Floating Iframe</p>
        <h1>
        ...
        <div style={{ display: popUpShown ? 'none' : 'block' }} className="floating-button">
          <div className="frame-content">
            <button className="tada-launcher-button" onClick={handleExpand}>
        ...
        <div className="popup" style={{ display: popUpShown ? 'block' : 'none' }}>
          ...
          <div className="floating-button" style={{ display: popUpShown ? 'block' : 'none' }}>
          <div className="frame-content">
              <button className="tada-launcher-button" onClick={handleCollapse}>
                <div style={{ backgroundColor: "#fe4c4c" }} className="tada-launcher-container tada-launcher-font-color-light tada-launcher-border-radius-circular tada-launcher-image-only launcher-closed" tabIndex="-1">
                  <div className="tada-launcher-close-icon tada-close-btn"></div>
                </div>
              </button>
